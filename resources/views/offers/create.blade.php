...
{{--        <form action="{{ route('offer.store') }}" method="POST">--}}
            {!! Form::open(['method'=>'POST', 'action'=>'Offer@store', 'files'=>true]) !!}
...
{{--                <label for="exampleInputEmail1">{{ __('message.offer name_ar') }}</label>--}}
            ...
            <div class="form-group">
                {!! Form::label('details_en', __('message.details_en')) !!}
            ...
            <div class="form-group">
                {!! Form::label('photo', __('message.choose image')) !!}
                <br>
            ...
            {!! Form::submit( __('message.send offer'), ['class'=>'btn btn-primary']) !!}
        {!! Form::close() !!}
    </div>
</div>
